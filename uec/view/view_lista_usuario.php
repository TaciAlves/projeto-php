        ...
        <table>
            ...
            foreach ($listaUsuarios as $usuario) : $cont++ ?>
                <tr>
                    <td><?= $cont ?></td>
                    <td>
                        <a href="http://localhost/uec/?pagina=4&id=<?= $usuario['id'] ?>">
                            <?= $usuario['email'] ?>
                        </a>
                    </td>
                    <td><?= substr($usuario['senha'], 0, 10); ?> ...</td>
                    <td>
                        <a href="http://localhost/uec/?pagina=4&id=<?= $usuario['id'] ?>" class="btn btn-light btn-sm">Editar</a>
                    </td>
                    <td>
                        <a href="http://localhost/uec/?pagina=5&id=<?= $usuario['id'] ?>" class="btn btn-light btn-sm">Apagar</a>
                    </td>
                </tr>
            <?php endforeach ?>
        </table>
